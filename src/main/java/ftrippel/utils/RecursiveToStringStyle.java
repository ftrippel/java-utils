...
/**
 * Use with ToStringBuilder.reflectionToString
 * 
...
public class RecursiveToStringStyle extends ToStringStyle {
	...
	/**
	 * Setting {@link #maxDepth} to 0 will have the same effect as using original {@link #ToStringStyle}: it will print all 1st level values without traversing
	 * into them. Setting to 1 will traverse up to 2nd level and so on.
	 */
